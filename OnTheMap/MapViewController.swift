        ...
        ParseClient.shared_instance().parseGetStudentLocations() { success, errorMsg in
            if success {
                ...
                for studentLocation in studentLocations {
                    ...
                    annotation.coordinate = getCoordinateFromStudent(studentLocation)
                    annotation.title = getFullNameFromStudent(studentLocation)
                    annotation.subtitle = getURLFromStudent(studentLocation)
